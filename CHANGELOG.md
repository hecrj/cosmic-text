...
- Use hinted line widths for layout measurements when `Hinting` is enabled, so
  that reported line widths and alignment corrections match the positions the
  glyphs are actually laid out at
